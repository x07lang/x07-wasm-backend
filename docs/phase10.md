...
- [`examples/x07_hex_min`](../examples/x07_hex_min/README.md) is the Tactics M0 reference reducer for deterministic select/move/end-turn flow backed by the `std-web-ui@0.2.6` audio/haptics helpers.
